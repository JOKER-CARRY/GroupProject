package com.admin.config;//package com.ofunx.config;
//
...
//        //放行路径（匿名访问）
//        filterChainDefinitionsMap.put("/res/**", "anon");//静态资源
...
//        filterChainDefinitionsMap.put("/reg", "anon");//去到注册
//        //用户放行
//        filterChainDefinitionsMap.put("/user/checkEmail", "anon");//检测邮箱
//        filterChainDefinitionsMap.put("/user/regist", "anon");//注册用户
//        filterChainDefinitionsMap.put("/user/login", "anon");//用户登录
//        filterChainDefinitionsMap.put("/blog*/**", "anon");//博客请求
//
//        filterChainDefinitionsMap.put("/reg.html", "anon");//去到注册
